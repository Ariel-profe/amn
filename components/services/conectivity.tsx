...
const transition = {
  ...
  export const GoogleGeminiEffect = ({
    ...
    return (
      <div className={cn("sticky top-20 px-3 mb-10 flex flex-col items-center justify-center", className)}>
        <Subtitle subtitle="Conectividad" />
        <p className="text-lg md:text-xl font-normal text-center text-neutral-600 dark:text-slate-400 my-4 max-w-lg mx-auto">
          {description ||
        ...
        <svg
          ...
          className=" absolute -top-60 md:-top-10 w-full"
        >
          <motion.path
